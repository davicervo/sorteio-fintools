                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            <a href="<?= ($brinde->funcionario_uid ? '#' : route('brindes.edit', $brinde->brinde_uid)) ?>">
                                <button type="button" class="btn btn-primary showload" @if($brinde->funcionario_uid) disabled @endif>
