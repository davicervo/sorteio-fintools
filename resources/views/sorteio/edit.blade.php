        ...
        <div class="col-sm-8">
            ...
            <form method="POST" action="{{route('sorteios.update', $sorteio->sorteio_uid)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" value="{{ old('titulo') ?? $sorteio->titulo }}">
                </div>

                <div class="form-group">
                    <label for="descricao">Descrição</label>
                    <textarea class="form-control" id="descricao" rows="5" name="descricao">{{ old('descricao') ?? $sorteio->descricao }}</textarea>
                </div>

                <div class="form-group">
                    <label for="data_sorteio">Data do sorteio</label>
                    <input type="date" class="form-control" id="data_sorteio" name="data_sorteio" value="{{ old('data_sorteio') ?? $sorteio->data_sorteio }}">
                </div>
