...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-8">
            ...
            <form method="POST" action="{{route('departamentos.update', ['uid' => $data->departamento_uid])}}">
                @csrf
                @method('patch')
                ...
                <a href="{{route('departamentos.index')}}" class="btn btn-secondary float-left showload">
